import 'package:bloc_with_services_boilerplate/core/constants/app_theme_mode.dart';
import 'package:bloc_with_services_boilerplate/core/constants/language.dart';
...
class AppBloc extends Bloc<AppEvent, AppState> {
  ...
  onChangeLanguage(ChangeLanguage event, Emitter<AppState> emit) async {
    await locator.get<LocalDataSource>().cacheLanguage(
  ...
  onChangeThemeMode(ChangeThemeMode event, Emitter<AppState> emit) async {
    await locator.get<LocalDataSource>().cacheThemeMode(
          event.selectedThemeMode.value.name,
        );
