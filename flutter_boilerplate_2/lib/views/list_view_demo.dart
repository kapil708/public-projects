...
import 'package:flutter_boilerplate_2/controllers/list_view_demo_controller.dart';
import 'package:flutter_boilerplate_2/global/packages/config_package.dart';
import 'package:flutter_boilerplate_2/global/widget/no_data_widget.dart';
      ...
      body: RefreshIndicator(
        ...
        child: PagedListView(
          ...
          builderDelegate: PagedChildBuilderDelegate(
            itemBuilder: (context, dynamic item, index) => Text(item['name']),
